...
#Apr,kpr,mcmcpr=neic.run_regression(inversion_type='bayesian',prior='uninformative',Niter=1000e3,burn=50e3,fix_exponent=False,dependent_variable='potency_rate')
...
i=where(neic.event_class=='i')[0]
plt.scatter(neic.moments[i],neic.mean_potency_rate[i],c='#87CEFA',marker='D',s=40,edgecolor='k')

i=where(neic.event_class=='u')[0]
plt.scatter(neic.moments[i],neic.mean_potency_rate[i],c='#DC143C',marker='s',s=40,edgecolor='k')

i=where(neic.event_class=='l')[0]
plt.scatter(neic.moments[i],neic.mean_potency_rate[i],c='#FFD700',marker='^',s=40,edgecolor='k')

i=where(neic.event_class=='n/a')[0]
plt.scatter(neic.moments[i],neic.mean_potency_rate[i],c='#228B22',marker='o',s=40,edgecolor='k')
...
plt.ylabel(r'Potency rate ($m^3/s$)',fontsize=14)
